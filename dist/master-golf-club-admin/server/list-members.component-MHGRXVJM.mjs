  ...
  loadMembers() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        yield Swal.fire("Error", "Failed to load members", "error");
      } finally {
        this.isLoading = false;
      }
    });
      ...
      try {
        ...
        if (result.isConfirmed) {
          ...
          if (response.data?.code === 1) {
            yield Swal.fire("Deleted!", "Member has been deleted.", "success");
        ...
        yield Swal.fire("Error", "Failed to delete member", "error");
      } finally {
        this.isLoading = false;
      }
    });
...
//# sourceMappingURL=list-members.component-MHGRXVJM.mjs.map
