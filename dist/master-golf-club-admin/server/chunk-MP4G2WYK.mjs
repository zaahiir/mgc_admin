...
import{a as g}from"./chunk-LQ5YHFJH.mjs";import{va as te}from"./chunk-PGUNMM7B.mjs";import{a as p}from"./chunk-RXOEWVMK.mjs";import{a as ae,b as oe}from"./chunk-PXEKN24T.mjs";import"./chunk-7VMQ7K6E.mjs";import{$ as Y,J as H,Ka as re,N as J,O as K,Z as Q,_ as X,h as G,i as z,la as Z,ma as ee,p as W,pa as ie,q,ra as ne,wa as se}from"./chunk-BTSLUG2I.mjs";import{Z as O,f as D,g as N,h as U,m as B,n as j}from"./chunk-3BNNXX2I.mjs";import{Db as m,Nb as n,Ob as s,Pb as k,Tb as C,Yb as x,_ as w,_b as d,gb as l,hb as y,ia as T,kc as e,lc as M,mc as E,oc as I,pc as L,qc as R,rc as F,ta as h,tc as V,ua as f,va as P,vc as S,xb as u,xc as $,zc as A}from"./chunk-BUS3XCSB.mjs";import{l as _}from"./chunk-DYLV4RNH.mjs";var le=(()=>{let c=class c{constructor(){this.apiUrl=new ae().getUrl(oe)}listMemberMessage(i="0"){let t=`${this.apiUrl}message/listing/${i}/`;return p.get(t)}processMemberMessage(i,t="0"){let o=`${this.apiUrl}message/processing/${t}/`;return p.post(o,i)}deleteMemberMessage(i){let t=`${this.apiUrl}message/deletion/${i}/`;return p.get(t)}markMessageAsRead(i){let t=`${this.apiUrl}message/mark_as_read/${i}/`;return p.post(t)}markMessageAsReplied(i){let t=`${this.apiUrl}message/mark_as_replied/${i}/`;return p.post(t)}markMessageAsClosed(i){let t=`${this.apiUrl}message/mark_as_closed/${i}/`;return p.post(t)}getNewMessages(){let i=`${this.apiUrl}message/new_messages/`;return p.get(i)}getMessageById(i){return _(this,null,function*(){try{let t=`${this.apiUrl}message/listing/${i}/`;console.log("Getting message by ID:",t);let o=yield p.get(t,{timeout:3e4});return console.log("Get message response:",o),o}catch(t){throw console.error("Error getting message by ID:",t),t}})}};c.\u0275fac=function(t){return new(t||c)},c.\u0275prov=w({token:c,factory:c.\u0275fac,providedIn:"root"});let a=c;return a})();var ge=a=>({"table-secondary":a}),ce=a=>({disabled:a}),pe=a=>({active:a});function ue(a,c){if(a&1){let r=C();n(0,"a",18),x("click",function(){h(r);let t=d().$implicit,o=d();return f(o.markMessageAsRead(t.id))}),e(1,`
                  `),P(),k(2,"svg",19),e(3,`
                `),s()}if(a&2){let r=d(2);l(2),m("cIcon",r.icons.cilPen)}}function xe(a,c){if(a&1){let r=C();n(0,"a",20),x("click",function(){h(r);let t=d().$implicit,o=d();return f(o.markMessageAsReplied(t.id))}),e(1,`
                  `),P(),k(2,"svg",21),e(3,`
                `),s()}if(a&2){let r=d(2);l(2),m("cIcon",r.icons.cilPen)}}function _e(a,c){if(a&1){let r=C();n(0,"a",22),x("click",function(){h(r);let t=d().$implicit,o=d();return f(o.markMessageAsClosed(t.id))}),e(1,`
                  `),P(),k(2,"svg",23),e(3,`
                `),s()}if(a&2){let r=d(2);l(2),m("cIcon",r.icons.cilPen)}}function he(a,c){if(a&1&&(n(0,"tr",13),e(1,`
              `),n(2,"td"),e(3),s(),e(4,`
    ...
    `),n(4,"c-card",1),e(5,`
      `),n(6,"c-card-body"),e(7,`
        ...
        `),n(18,"table",5),e(19,`
          ...
          `),s(),e(49,`
          `),n(50,"tbody"),e(51,`
            `),u(52,he,39,17,"tr",9),e(53,`
            `),u(54,fe,5,1,"tr",10),e(55,`
          `),s(),e(56,`
        `),s(),e(57,`

        `),e(58,`
        `),u(59,Ce,16,7,"c-pagination",11),e(60,`
...
`),s()),t&2&&(l(13),L("ngModel",o.searchTerm),l(5),m("hover",!0)("striped",!0)("bordered",!0),l(34),m("ngForOf",o.paginatedMessageList),l(2),m("ngIf",o.paginatedMessageList.length===0),l(5),m("ngIf",o.messageList.length>o.itemsPerPage),l(6),I(`
          ...
          `))},dependencies:[j,D,N,U,B,ee,G,K,J,W,q,re,ie,ne,se,H,z,Z,Y,X,Q]});let a=c;return a})();export{Ve as MemberMessageComponent};
