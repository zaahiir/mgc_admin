...
var routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: "dashboard",
        loadChildren: () => import("./routes-GLW4WRSA.mjs").then((m) => m.dashboardRoutes)
      },
      {
        path: "about",
        loadChildren: () => import("./routes-GCGY7WS3.mjs").then((m) => m.aboutRoutes)
      },
      {
        path: "bookings",
        loadChildren: () => import("./routes-2YVIUYIH.mjs").then((m) => m.bookingRoutes)
      },
      {
        path: "members",
        loadChildren: () => import("./routes-NTUDAGI4.mjs").then((m) => m.membersRoutes)
      },
      {
        path: "plan",
        loadChildren: () => import("./routes-C3PMSQBK.mjs").then((m) => m.planRoutes)
      },
      {
        path: "courses",
        loadChildren: () => import("./routes-F7RUSU4P.mjs").then((m) => m.coursesRoutes)
      },
      {
        path: "events",
        loadChildren: () => import("./routes-COI27V7A.mjs").then((m) => m.eventsRoutes)
      },
      {
        path: "tournament",
        loadChildren: () => import("./routes-SKYX3HUO.mjs").then((m) => m.tournamentRoutes)
      },
      {
        path: "team",
        loadChildren: () => import("./routes-MW23KFWJ.mjs").then((m) => m.teamRoutes)
      },
      {
        path: "faq",
        loadChildren: () => import("./routes-77TT4Z2R.mjs").then((m) => m.faqRoutes)
      },
      {
        path: "scoreBoard",
        loadChildren: () => import("./routes-LCK533FT.mjs").then((m) => m.scoreBoardRoutes)
      },
      {
        path: "blog",
        loadChildren: () => import("./routes-ZSB3YME3.mjs").then((m) => m.blogRoutes)
      },
      {
        path: "concept",
        loadChildren: () => import("./routes-EMQAZVJO.mjs").then((m) => m.couponRoutes)
      },
      {
        path: "coupon",
        loadChildren: () => import("./routes-EWF7SZFM.mjs").then((m) => m.couponRoutes)
      },
      {
        path: "enquiry",
        loadChildren: () => import("./routes-BFYJKOSJ.mjs").then((m) => m.enquiryRoutes)
      },
      {
        path: "memberEnquiry",
        loadChildren: () => import("./routes-A45PVQGF.mjs").then((m) => m.memberEnquiryRoutes)
      },
      {
        path: "memberMessage",
        loadChildren: () => import("./routes-IWG22HZN.mjs").then((m) => m.memberMessageRoutes)
      },
      {
        path: "amenities",
        loadChildren: () => import("./routes-U6VXFGWU.mjs").then((m) => m.amenitiesRoutes)
      }
    ]
  },
...
//# sourceMappingURL=chunk-GXXFHMUF.mjs.map
