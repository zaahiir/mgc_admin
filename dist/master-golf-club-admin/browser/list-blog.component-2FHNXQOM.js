    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (response.data.code === 1) {
          ...
          yield import_sweetalert2.default.fire("Error", "Failed to load blog list", "error");
        }
      } catch (error) {
        console.error("Error loading blog list:", error);
        yield import_sweetalert2.default.fire("Error", "An error occurred while loading the blog list", "error");
      } finally {
        this.isLoading = false;
      }
    });
    ...
    return __async(this, null, function* () {
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          if (response.data.code === 1) {
            yield import_sweetalert2.default.fire("Deleted!", "Blog has been deleted.", "success");
            yield this.loadBlogList();
          } else {
            yield import_sweetalert2.default.fire("Error", "Failed to delete blog", "error");
          }
        } catch (error) {
          console.error("Error deleting blog:", error);
          yield import_sweetalert2.default.fire("Error", "An error occurred while deleting the blog", "error");
        } finally {
          this.isLoading = false;
        }
      }
...
//# sourceMappingURL=list-blog.component-2FHNXQOM.js.map
