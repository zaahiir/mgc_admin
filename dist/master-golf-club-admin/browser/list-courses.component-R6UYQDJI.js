    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (response.data.code === 1) {
          ...
          yield import_sweetalert2.default.fire("Error", "Failed to load Course list", "error");
        }
      } catch (error) {
        console.error("Error loading Course list:", error);
        yield import_sweetalert2.default.fire("Error", "An error occurred while loading the Course list", "error");
      } finally {
        this.isLoading = false;
      }
    });
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          if (response.data.code === 1) {
            ...
            yield import_sweetalert2.default.fire("Deleted!", "Course has been deleted.", "success");
            yield this.loadCourseList();
          } else {
            yield import_sweetalert2.default.fire("Error", "Failed to delete Course", "error");
          }
        } catch (error) {
          console.error("Error deleting Course:", error);
          yield import_sweetalert2.default.fire("Error", "An error occurred while deleting the Course", "error");
        } finally {
          this.isLoading = false;
        }
      }
...
//# sourceMappingURL=list-courses.component-R6UYQDJI.js.map
