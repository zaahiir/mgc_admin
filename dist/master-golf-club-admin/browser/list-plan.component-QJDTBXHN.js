    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (response.data.code === 1) {
          ...
          yield import_sweetalert2.default.fire("Error", "Failed to load Plan list", "error");
        }
      } catch (error) {
        console.error("Error loading Plan list:", error);
        yield import_sweetalert2.default.fire("Error", "An error occurred while loading the Plan list", "error");
      } finally {
        this.isLoading = false;
      }
    });
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          if (response.data.code === 1) {
            ...
            yield import_sweetalert2.default.fire("Deleted!", "Plan has been deleted.", "success");
            yield this.loadPlanList();
          } else {
            yield import_sweetalert2.default.fire("Error", "Failed to delete Plan", "error");
          }
        } catch (error) {
          console.error("Error deleting Plan:", error);
          yield import_sweetalert2.default.fire("Error", "An error occurred while deleting the Plan", "error");
        } finally {
          this.isLoading = false;
        }
      }
...
//# sourceMappingURL=list-plan.component-QJDTBXHN.js.map
