...
// src/app/views/coupon/list-coupon/list-coupon.component.ts
var _c0 = () => ["/coupon/add"];
var _c1 = () => ["/coupon/update"];
var _ListCouponComponent = class _ListCouponComponent {
  constructor() {
...
_ListCouponComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListCouponComponent, selectors: [["app-list-coupon"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 76, vars: 12, consts: [["xs", "12"], [1, "mb-4"], ["cForm", "", 1, "row", "g-3"], [1, "col-auto"], ["cButton", "", "color", "primary", "role", "button", 3, "routerLink"], ["md", "3", 1, "mb-4", "flex", "justify-content-md-end"], ["cFormControl", "", "id", "validationCustom09", "type", "search", "placeholder", "search", 3, "input", "ngModelChange", "ngModel"], ["cTable", "", 3, "hover", "striped", "bordered"], ["scope", "col"], ["cButton", "", "color", "btn-transparent", "role", "button", "cTooltipPlacement", "top", 1, "btn-sm", "text-primary", "border-0", "py-0", 3, "routerLink", "cTooltip"], ["size", "xl", "title", "List Icon", 3, "cIcon"], ["cButton", "", "color", "btn-transparent", "role", "button", "cTooltipPlacement", "top", 1, "btn-sm", "text-danger", "border-0", "py-0", 3, "cTooltip"], ["width", "25", "title", "List Icon", 3, "cIcon"]], template: function ListCouponComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("input", function ListCouponComponent_Template_input_input_17_listener() {
      return ctx.search();
    });
    \u0275\u0275twoWayListener("ngModelChange", function ListCouponComponent_Template_input_ngModelChange_17_listener($event) {
...
var ListCouponComponent = _ListCouponComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ListCouponComponent, { className: "ListCouponComponent", filePath: "src\\app\\views\\coupon\\list-coupon\\list-coupon.component.ts", lineNumber: 17 });
})();
export {
  ListCouponComponent
};
//# sourceMappingURL=list-coupon.component-Y745OWT4.mjs.map
