...
var _UpdatePlanComponent = class _UpdatePlanComponent {
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (response.data.code === 1) {
          ...
          yield import_sweetalert2.default.fire("Updated!", response.data.message, "success");
  ...
  showError(message) {
    return __async(this, null, function* () {
      yield import_sweetalert2.default.fire("Failed!", message, "error");
    });
  }
};
...
//# sourceMappingURL=update-plan.component-KHLTARKW.js.map
