...
import{a as vt}from"./chunk-6HFSODRI.mjs";import{a as E}from"./chunk-LQ5YHFJH.mjs";import{Pa as xt,va as pt}from"./chunk-PGUNMM7B.mjs";import"./chunk-RXOEWVMK.mjs";import"./chunk-PXEKN24T.mjs";import"./chunk-7VMQ7K6E.mjs";import{$ as st,C as it,J as nt,Ka as Ct,La as yt,N as ot,O as at,Z as rt,_ as ct,h as X,i as Z,la as lt,ma as mt,p as tt,pa as gt,q as et,ra as dt,sa as ht,ua as _t,wa as ft,xa as ut}from"./chunk-BTSLUG2I.mjs";import{G as K,_ as Q,f as U,g as Y,h as q,n as J}from"./chunk-3BNNXX2I.mjs";import{Ac as w,Cb as P,Db as m,Eb as S,Hb as B,Nb as a,Ob as r,Pb as C,Qb as I,Rb as b,Tb as L,Yb as _,_b as x,ab as N,bb as D,cb as V,gb as s,hb as A,ia as k,jc as y,kc as t,lc as v,mc as R,pc as $,qc as H,rc as W,ta as f,tc as j,ua as u,uc as G,va as M,vc as T,wa as F,xb as g}from"./chunk-BUS3XCSB.mjs";import{l as O}from"./chunk-DYLV4RNH.mjs";var wt=()=>["/amenities/add"],Pt=n=>["/amenities/update",n],St=n=>["amenity-icon-svg",n],It=n=>["amenity-icon-img",n],bt=n=>["amenity-icon-placeholder",n];function Lt(n,p){n&1&&(a(0,"div",15),t(1,`
          `),a(2,"div",16),t(3,`
            `),a(4,"span",17),t(5,"Loading..."),r(),t(6,`
          `),r(),t(7,`
        `),r())}function Tt(n,p){if(n&1&&(I(0),t(1,`
                    `),a(2,"div",28),t(3,`
                    `),r(),t(4,`
                  `),b()),n&2){let i=p.ngIf,e=x().$implicit;s(2),m("innerHTML",i,D)("title",e.tooltip||e.amenityTooltip||e.title||e.amenityName)}}function Et(n,p){if(n&1&&(I(0),t(1,`
                       `),M(),a(2,"svg",29),t(3,`
                         `),C(4,"path",30),t(5,`
                       `),r(),t(6,`
                     `),b()),n&2){let i=x(2).$implicit,e=x(2);s(2),m("ngClass",T(6,St,e.getIconSizeClass(i)))("title",i.tooltip||i.amenityTooltip||i.title||i.amenityName),P("width",e.getIconWidth(i))("height",e.getIconHeight(i))("viewBox",e.getViewBox(i)),s(2),P("d",e.getIconPath(i))}}function zt(n,p){if(n&1&&(t(0,`
                     `),g(1,Et,7,8,"ng-container",23),t(2,`
                   `)),n&2){let i=x().$implicit,e=y(19),o=x(2);s(),m("ngIf",o.getIconPath(i))("ngIfElse",e)}}function Mt(n,p){if(n&1){let i=L();I(0),t(1,`
                       `),a(2,"img",31),_("error",function(o){f(i);let c=x(2).$implicit,l=x(2);return u(l.onImageError(o,c))}),r(),t(3,`
                     `),b()}if(n&2){let i=x(2).$implicit,e=x(2);s(2),S("width",e.getIconWidth(i),"px")("height",e.getIconHeight(i),"px"),m("src",i.icon||i.amenity_icon_url,V)("alt",i.title||i.amenityName)("title",i.tooltip||i.amenityTooltip||i.title||i.amenityName)("ngClass",T(8,It,e.getIconSizeClass(i)))}}function Ot(n,p){if(n&1&&(t(0,`
                     `),g(1,Mt,4,10,"ng-container",23),t(2,`
                   `)),n&2){let i=x().$implicit,e=y(23);s(),m("ngIf",i.icon||i.amenity_icon_url)("ngIfElse",e)}}function At(n,p){if(n&1&&(I(0),t(1,`
                       `),C(2,"i",32),t(3,`
                     `),b()),n&2){let i=x(2).$implicit,e=x(2);s(2),B("fas amenity-icon-font "+(i.amenityIcon||i.icon_file)+" "+e.getIconSizeClass(i)),S("font-size",e.getIconSize(i)*.625,"px"),m("title",i.tooltip||i.amenityTooltip||i.title||i.amenityName)}}function kt(n,p){if(n&1&&(t(0,`
                     `),g(1,At,4,5,"ng-container",23),t(2,`
                   `)),n&2){let i=x().$implicit,e=y(27);s(),m("ngIf",i.amenityIcon||i.icon_file)("ngIfElse",e)}}function Ft(n,p){if(n&1&&(t(0,`
                     `),a(1,"div",29),t(2,`
                       `),C(3,"i",33),t(4,`
                     `),r(),t(5,`
                   `)),n&2){let i=x().$implicit,e=x(2);s(),S("width",e.getIconWidth(i),"px")("height",e.getIconHeight(i),"px"),m("ngClass",T(8,bt,e.getIconSizeClass(i)))("title",i.tooltip||i.amenityTooltip||i.title||i.amenityName),s(2),S("font-size",e.getIconSize(i)*.5,"px")}}function Nt(n,p){if(n&1){let i=L();a(0,"tr"),t(1,`
              `),a(2,"td"),t(3),r(),t(4,`
                             `),a(5,"td",15),t(6,`
                 `),t(7,`
                 `),a(8,"div",22),t(9,`
                  `),t(10,`
                  `),g(11,Tt,5,2,"ng-container",23),t(12,`

                                     `),t(13,`
                   `),g(14,zt,3,2,"ng-template",null,0,w),t(16,`

                                     `),t(17,`
                   `),g(18,Ot,3,2,"ng-template",null,1,w),t(20,`

                   `),t(21,`
                   `),g(22,kt,3,2,"ng-template",null,2,w),t(24,`

                   `),t(25,`
                   `),g(26,Ft,6,10,"ng-template",null,3,w),t(28,`
                `),r(),t(29,`
              `),r(),t(30,`
              `),a(31,"td"),t(32),r(),t(33,`
              `),a(34,"td"),t(35),r(),t(36,`
              ...
              `),a(40,"td"),t(41,`
                ...
                `),r(),t(51,`
              `),r(),t(52,`
            `),r()}if(n&2){let i=p.$implicit,e=p.index,o=y(15),c=x(2);s(3),v((c.currentPage-1)*c.itemsPerPage+e+1),s(5),m("ngClass",c.getContainerSizeClass(i)),s(3),m("ngIf",c.getSafeIconSvg(i))("ngIfElse",o),s(21),v(i.title||i.amenityName),s(3),v(i.tooltip||i.amenityTooltip||i.title||i.amenityName),s(3),v(i.description||i.amenitiesDescription),s(4),m("routerLink",T(12,Pt,i.id))("cTooltip",c.tooltipEditText),s(2),m("cIcon",c.icons.cilPen),s(3),m("cTooltip",c.tooltipDeleteText),s(2),m("cIcon",c.icons.cilTrash)}}function Dt(n,p){if(n&1&&(a(0,"span"),t(1),r()),n&2){let i=x(3);s(),R('No amenities found matching "',i.searchTerm,'"')}}function Vt(n,p){n&1&&t(0,"No amenities available")}function Bt(n,p){if(n&1&&(a(0,"tr"),t(1,`
              `),a(2,"td",34),t(3,`
                `),g(4,Dt,2,1,"span",23),t(5,`
                `),g(6,Vt,1,0,"ng-template",null,4,w),t(8,`
              `),r(),t(9,`
            `),r()),n&2){let i=y(7),e=x(2);s(4),m("ngIf",e.searchTerm)("ngIfElse",i)}}function Rt(n,p){if(n&1&&(a(0,"table",18),t(1,`
          `),a(2,"thead"),t(3,`
            `),a(4,"tr"),t(5,`
