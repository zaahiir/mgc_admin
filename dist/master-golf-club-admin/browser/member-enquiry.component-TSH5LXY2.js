...
var _MemberEnquiryComponent = class _MemberEnquiryComponent {
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (response.data.code === 1) {
          ...
          yield import_sweetalert2.default.fire("Error", "Failed to load member enquiry list", "error");
        }
      } catch (error) {
        yield import_sweetalert2.default.fire("Error", "An error occurred while loading the list", "error");
      } finally {
        this.isLoading = false;
      }
    });
  ...
  convertToMember(enquiryId) {
    ...
    if (enquiry?.isConverted) {
      import_sweetalert2.default.fire("Info", "This enquiry has already been converted to a member.", "info");
      return;
    }
...
//# sourceMappingURL=member-enquiry.component-TSH5LXY2.js.map
