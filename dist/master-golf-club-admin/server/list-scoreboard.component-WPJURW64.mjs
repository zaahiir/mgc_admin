...
// src/app/views/scoreboard/list-scoreboard/list-scoreboard.component.ts
var _c0 = () => ["/scoreBoard/add"];
var _c1 = () => ["/scoreBoard/update"];
var _ListScoreboardComponent = class _ListScoreboardComponent {
  constructor() {
...
_ListScoreboardComponent.\u0275fac = function ListScoreboardComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ListScoreboardComponent)();
};
_ListScoreboardComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ListScoreboardComponent, selectors: [["app-list-scoreboard"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 76, vars: 12, consts: [["xs", "12"], [1, "mb-4"], ["cForm", "", 1, "row", "g-3"], [1, "col-auto"], ["cButton", "", "color", "primary", "role", "button", 3, "routerLink"], ["md", "3", 1, "mb-4", "flex", "justify-content-md-end"], ["cFormControl", "", "id", "validationCustom09", "type", "search", "placeholder", "search", 3, "input", "ngModelChange", "ngModel"], ["cTable", "", 3, "hover", "striped", "bordered"], ["scope", "col"], ["cButton", "", "color", "btn-transparent", "role", "button", "cTooltipPlacement", "top", 1, "btn-sm", "text-primary", "border-0", "py-0", 3, "routerLink", "cTooltip"], ["size", "xl", "title", "List Icon", 3, "cIcon"], ["cButton", "", "color", "btn-transparent", "role", "button", "cTooltipPlacement", "top", 1, "btn-sm", "text-danger", "border-0", "py-0", 3, "cTooltip"], ["width", "25", "title", "List Icon", 3, "cIcon"]], template: function ListScoreboardComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-col", 0)(1, "c-card", 1)(2, "c-card-body")(3, "form", 2)(4, "div", 3)(5, "a", 4);
    \u0275\u0275text(6, "Create scoreBoard");
    \u0275\u0275elementEnd()()()()()();
    ...
    \u0275\u0275listener("input", function ListScoreboardComponent_Template_input_input_17_listener() {
      return ctx.search();
    });
    \u0275\u0275twoWayListener("ngModelChange", function ListScoreboardComponent_Template_input_ngModelChange_17_listener($event) {
...
var ListScoreboardComponent = _ListScoreboardComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ListScoreboardComponent, { className: "ListScoreboardComponent", filePath: "src\\app\\views\\scoreboard\\list-scoreboard\\list-scoreboard.component.ts", lineNumber: 17 });
})();
export {
  ListScoreboardComponent
};
//# sourceMappingURL=list-scoreboard.component-WPJURW64.mjs.map
