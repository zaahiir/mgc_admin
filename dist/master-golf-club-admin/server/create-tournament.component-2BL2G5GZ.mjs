...
// src/app/views/tournament/create-tournament/create-tournament.component.ts
function CreateTournamentComponent_c_form_feedback_23_Template(rf, ctx) {
  if (rf & 1) {
...
function CreateTournamentComponent_c_form_feedback_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-form-feedback", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreateTournamentComponent_c_form_feedback_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-form-feedback", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreateTournamentComponent_c_form_feedback_53_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-form-feedback", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreateTournamentComponent_c_form_feedback_63_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-form-feedback", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreateTournamentComponent_c_form_feedback_73_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-form-feedback", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function CreateTournamentComponent_c_form_feedback_83_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "c-form-feedback", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
var _CreateTournamentComponent = class _CreateTournamentComponent {
...
_CreateTournamentComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CreateTournamentComponent, selectors: [["app-create-tournament"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 99, vars: 18, consts: [["xs", "12"], [1, "mb-4"], ["cForm", "", 1, "row", "g-3", "needs-validation", 3, "ngSubmit", "formGroup"], ["md", "6", 3, "cFormFloating"], ["cFormControl", "", "id", "tournamentName", "formControlName", "tournamentName", "required", "", "type", "text", "placeholder", "Tournament Name"], ["cLabel", "", "for", "tournamentName", 1, "ms-2"], [3, "valid", 4, "ngIf"], ["cFormControl", "", "id", "tournamentDate", "formControlName", "tournamentDate", "required", "", "type", "date", "placeholder", "Tournament Date"], ["cLabel", "", "for", "tournamentDate", 1, "ms-2"], ["cFormControl", "", "id", "tournamentTime", "formControlName", "tournamentTime", "required", "", "type", "time", "placeholder", "Tournament Time"], ["cLabel", "", "for", "tournamentTime", 1, "ms-2"], ["cFormControl", "", "id", "tournamentLocation", "formControlName", "tournamentLocation", "required", "", "type", "text", "placeholder", "Tournament Location"], ["cLabel", "", "for", "tournamentLocation", 1, "ms-2"], ["md", "12", 3, "cFormFloating"], ["cFormControl", "", "id", "tournamentDescription", "formControlName", "tournamentDescription", "required", "", "rows", "3", "placeholder", "Tournament Description"], ["cLabel", "", "for", "tournamentDescription", 1, "ms-2"], ["cFormControl", "", "id", "entryFee", "formControlName", "entryFee", "required", "", "type", "number", "step", "0.01", "placeholder", "Entry Fee"], ["cLabel", "", "for", "entryFee", 1, "ms-2"], ["cFormControl", "", "id", "maxParticipants", "formControlName", "maxParticipants", "required", "", "type", "number", "placeholder", "Max Participants"], ["cLabel", "", "for", "maxParticipants", 1, "ms-2"], ["cButton", "", "color", "primary", "type", "submit", 1, "me-1", 3, "disabled"], ["cButton", "", "color", "secondary", "type", "button", 3, "click", "disabled"], [3, "valid"]], template: function CreateTournamentComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(9, "Create New Tournament");
    \u0275\u0275elementEnd();
    \u0275\u0275text(10, "\n        ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(11, "\n        ");
    ...
    \u0275\u0275listener("ngSubmit", function CreateTournamentComponent_Template_form_ngSubmit_14_listener() {
      return ctx.onSubmit();
    });
    \u0275\u0275text(15, "\n            ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(22, "\n              ");
    \u0275\u0275template(23, CreateTournamentComponent_c_form_feedback_23_Template, 2, 2, "c-form-feedback", 6);
    \u0275\u0275text(24, "\n            ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(25, "\n  \n            ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(32, "\n              ");
    \u0275\u0275template(33, CreateTournamentComponent_c_form_feedback_33_Template, 2, 2, "c-form-feedback", 6);
    \u0275\u0275text(34, "\n            ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(35, "\n  \n            ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(42, "\n              ");
    \u0275\u0275template(43, CreateTournamentComponent_c_form_feedback_43_Template, 2, 2, "c-form-feedback", 6);
    \u0275\u0275text(44, "\n            ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(45, "\n  \n            ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(52, "\n              ");
    \u0275\u0275template(53, CreateTournamentComponent_c_form_feedback_53_Template, 2, 2, "c-form-feedback", 6);
    \u0275\u0275text(54, "\n            ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(55, "\n  \n            ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(62, "\n              ");
    \u0275\u0275template(63, CreateTournamentComponent_c_form_feedback_63_Template, 2, 2, "c-form-feedback", 6);
    \u0275\u0275text(64, "\n            ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(65, "\n  \n            ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(72, "\n              ");
    \u0275\u0275template(73, CreateTournamentComponent_c_form_feedback_73_Template, 2, 2, "c-form-feedback", 6);
    \u0275\u0275text(74, "\n            ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(75, "\n  \n            ");
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275text(82, "\n              ");
    \u0275\u0275template(83, CreateTournamentComponent_c_form_feedback_83_Template, 2, 2, "c-form-feedback", 6);
    \u0275\u0275text(84, "\n            ");
    \u0275\u0275elementEnd();
    \u0275\u0275text(85, "\n  \n            ");
    ...
    \u0275\u0275listener("click", function CreateTournamentComponent_Template_button_click_91_listener() {
      return ctx.onReset();
    });
    \u0275\u0275text(92, "\n                Reset Form\n              ");
    \u0275\u0275elementEnd();
...
var CreateTournamentComponent = _CreateTournamentComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CreateTournamentComponent, { className: "CreateTournamentComponent", filePath: "src\\app\\views\\tournament\\create-tournament\\create-tournament.component.ts", lineNumber: 22 });
})();
export {
  CreateTournamentComponent
};
//# sourceMappingURL=create-tournament.component-2BL2G5GZ.mjs.map
